...
select * from salesreps;
open cursor_scroll
	fetch last from cursor_scroll; -- ïîñëåäíÿÿ ñòðîêà
	fetch prior from cursor_scroll; -- ïðåäûäóùàÿ ñòðîêà
	fetch first from cursor_scroll; -- ïåðâàÿ ñòðîêà
	fetch absolute 3 from cursor_scroll; -- ñòðîêà ïî àáñ. íîìåðó
	fetch relative 4 from cursor_scroll; -- ñòðîêà ñî ñìåùåíèåì îò òåêóùåé
close cursor_scroll;
