...
--—пециальные типы данных в SQL Server - XML.
...
--1.4.	Ёлемент City, атрибуты Ц City_Name (наименование города), City_Employee_Count (общее количество сотрудников в городе), City_Chef (фамили€ руководител€ подразделени€).
